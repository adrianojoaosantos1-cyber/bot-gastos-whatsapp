...
class SheetsRepo:
    ...
    def get_active_accounts(self, client_sheet_id: str) -> List[str]:
        # Contas!A2:D -> conta, tipo, saldo_inicial, ativo
    ...
    def get_categories_map(self, client_sheet_id: str) -> Dict[str, str]:
        # Categorias!A2:C -> categoria, apelidos, ativo
        ...
        for row in values:
            ...
            # categoria também vale como "apelido"
